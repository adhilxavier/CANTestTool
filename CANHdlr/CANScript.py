...
#CanDLLName = 'C:\\Program Files (x86)\\USB_CAN TOOL\\ControlCAN.dll' #Put the DLL in the corresponding directory
#CanDLLName = 'C:\\Program Files (x86)\\USB_CAN TOOL\\driver\\WdfCoInstaller01011.dll' #Put the DLL in the corresponding directory
canDLL = windll.LoadLibrary('C:\\Program Files (x86)\\USB_CAN TOOL\\ControlCAN.dll')
